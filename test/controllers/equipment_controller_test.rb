...
class EquipmentControllerTest < ActionController::TestCase
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post :create, equipment: { item_inst_id: @equipment.item_inst_id, pet_id: @equipment.pet_id }
    end
  ...
  test "should update equipment" do
    patch :update, id: @equipment, equipment: { item_inst_id: @equipment.item_inst_id, pet_id: @equipment.pet_id }
    assert_redirected_to equipment_path(assigns(:equipment))
  end

...
class TownsControllerTest < ActionController::TestCase
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post :create, town: { description: @town.description, image_url: @town.image_url, name: @town.name }
    end
  ...
  test "should update town" do
    patch :update, id: @town, town: { description: @town.description, image_url: @town.image_url, name: @town.name }
    assert_redirected_to town_path(assigns(:town))
  end
